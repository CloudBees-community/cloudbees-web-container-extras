 ...
 */
public class PrivateAppValveIntegratedTest extends TomcatBaseTest {
    PrivateAppValve privateAppValve;
    String accessKey = "";
    ...
    public void basic_authentication_scenario() throws Exception {
        ...
        authentication_scenario(PrivateAppValve.AuthenticationEntryPoint.BASIC_AUTH);
    }

    @Test
    public void http_header_authentication_scenario() throws Exception {
        System.out.println("http_header_authentication_scenario");
        authentication_scenario(PrivateAppValve.AuthenticationEntryPoint.HTTP_HEADER_AUTH);
    }
    ...
    public void http_parameter_authentication_scenario() throws Exception {
        ...
        authentication_scenario(PrivateAppValve.AuthenticationEntryPoint.HTTP_PARAM_AUTH);
    }
...

        {
            ...
            switch (authenticationEntryPoint) {
                ...
                case HTTP_PARAM_AUTH:
                    URI uri = new URIBuilder("/").addParameter(privateAppValve.getAuthenticationParameterName(), secretKey).build();
